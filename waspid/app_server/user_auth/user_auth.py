...
#   - V1 agentic core (SDK): https://github.com/Waspid/software-agent-sdk
#   - V1 application server (in this repo): waspid/app_server/
# Unless you are working on deprecation, please avoid extending this legacy file and consult the V1 codepaths above.
# Tag: Legacy-V0
# This module belongs to the old V0 web server. The V1 application server lives under waspid/app_server/.
...
class UserAuth(ABC):
    ...
    This is an extension point in Waspid that allows applications to provide their own
