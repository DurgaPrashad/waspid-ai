...
from waspid import tools  # type: ignore[attr-defined]
...
from waspid.sdk import ConversationExecutionStatus, Event
...
async def on_conversation_update(
    ...
    union so both Waspid (``Agent``) and ACP (``ACPAgent``) payloads are
...
async def get_secret(
    ...
    try:
        ...
        if user_id:
            ...
            # Waspid (OSS mode) - use default user auth
