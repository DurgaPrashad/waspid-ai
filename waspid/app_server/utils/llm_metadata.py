...
def should_set_litellm_extra_body(model_name: str) -> bool:
    ...
    Only set litellm_extra_body for waspid models to avoid issues
    with providers that don't support extra_body parameters.

    The SDK internally translates "waspid/" prefix to "litellm_proxy/"
    ...
    """
    return 'waspid/' in model_name or 'litellm_proxy/' in model_name
...
def get_llm_metadata(
    ...
    """Generate LLM metadata for Waspid V1 conversations.
    ...
    """
    waspid_version = waspid.__version__

    metadata: dict[str, Any] = {
        'trace_version': waspid_version,
        'tags': [
            'app:waspid',
            f'model:{model_name}',
            f'type:{llm_type}',
            f'web_host:{os.environ.get("WEB_HOST", "unspecified")}',
            f'waspid_version:{waspid_version}',
