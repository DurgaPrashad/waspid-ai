...
# skills/ is at the repo root, two levels above the waspid package __file__
GLOBAL_SKILLS_DIR = Path(waspid.__file__).parent.parent / 'skills'
USER_SKILLS_DIR = Path.home() / '.waspid' / 'microagents'
