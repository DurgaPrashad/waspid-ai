...
This package provides server and sandbox functionality to interact with the Waspid Software Agent SDK. It exposes REST API endpoints for managing conversations, sandboxes, events, and user settings.
