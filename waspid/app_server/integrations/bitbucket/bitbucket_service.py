...
from waspid.app_server.integrations.bitbucket.service import (
...
class BitBucketService(
    ...
    This is an extension point in Waspid that allows applications to customize Bitbucket
...
bitbucket_service_cls = os.environ.get(
    'WASPID_BITBUCKET_SERVICE_CLS',
    'waspid.app_server.integrations.bitbucket.bitbucket_service.BitBucketService',
)
