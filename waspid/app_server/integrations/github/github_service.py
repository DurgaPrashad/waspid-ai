...
from waspid.app_server.integrations.github.service import (
    GitHubBranchesMixin,
    GitHubFeaturesMixin,
    GitHubPRsMixin,
    GitHubReposMixin,
...
class GitHubService(
    ...
    This is an extension point in Waspid that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    'WASPID_GITHUB_SERVICE_CLS',
    'waspid.app_server.integrations.github.github_service.GitHubService',
)
