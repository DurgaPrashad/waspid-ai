...
from waspid.app_server.integrations.forgejo.service import (
...
forgejo_service_cls = os.environ.get(
    'WASPID_FORGEJO_SERVICE_CLS',
    'waspid.app_server.integrations.forgejo.forgejo_service.ForgejoService',
)
