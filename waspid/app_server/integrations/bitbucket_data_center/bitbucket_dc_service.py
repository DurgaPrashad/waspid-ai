...
from waspid.app_server.integrations.bitbucket_data_center.service import (
...
class BitbucketDCService(
    ...
    This is an extension point in Waspid that allows applications to customize Bitbucket data center
    integration behavior. Applications can substitute their own implementation by:
    1. Creating a class that inherits from GitService
    2. Implementing all required methods
    3. Setting server_config.bitbucket_service_class to the fully qualified name of the class

    The class is instantiated via get_impl() in waspid.app_server.shared.py.
    """
...
bitbucket_dc_service_cls = os.environ.get(
    'WASPID_BITBUCKET_DATA_CENTER_SERVICE_CLS',
    'waspid.app_server.integrations.bitbucket_data_center.bitbucket_dc_service.BitbucketDCService',
)
