...
from waspid.app_server.integrations.gitlab.service import (
    GitLabBranchesMixin,
    GitLabFeaturesMixin,
    GitLabPRsMixin,
    GitLabReposMixin,
...
class GitLabService(
    ...
    This is an extension point in Waspid that allows applications to customize GitLab
...
gitlab_service_cls = os.environ.get(
    'WASPID_GITLAB_SERVICE_CLS',
    'waspid.app_server.integrations.gitlab.gitlab_service.GitLabService',
)
