...
from waspid.app_server.errors import AuthError
...
from waspid.app_server.secrets.secrets_models import (
    CustomSecretCreate,
    CustomSecretPage,
...
from waspid.app_server.utils.models import EditResponse
...
async def search_custom_secrets(
    ...
    In SaaS mode, includes the system-generated WASPID_API_KEY which cannot be deleted.
