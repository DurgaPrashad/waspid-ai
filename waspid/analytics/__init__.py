"""Waspid analytics package.

Provides a module-level singleton pattern for the AnalyticsService.

Usage::

    from waspid.analytics import init_analytics_service, get_analytics_service
...
from waspid.analytics.analytics_context import (
    AnalyticsContext,
    resolve_analytics_context,
)
from waspid.analytics.analytics_service import AnalyticsService
