...
the get_impl() pattern used throughout Waspid. Enterprise deployments provide
...
from waspid.analytics.user_base import UserBase
from waspid.analytics.user_provider import AnalyticsUserProvider
