...
The service is deployed as part of the waspid Helm chart. To enable it, set the following in your values.yaml:
...
- Kubernetes cluster with the waspid chart deployed
