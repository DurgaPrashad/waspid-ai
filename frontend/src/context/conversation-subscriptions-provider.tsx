...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => WaspidParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is WaspidParsedEvent =>
  isWaspidEvent(event) &&
