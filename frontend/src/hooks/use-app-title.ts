...
const APP_TITLE_OSS = "Waspid";
const APP_TITLE_SAAS = "Waspid Cloud";

/**
 * Hook that returns the appropriate document title based on app_mode and current route.
 * - For conversation pages: "Conversation Title | Waspid" or "Conversation Title | Waspid Cloud"
 * - For other pages: "Waspid" or "Waspid Cloud"
 */
