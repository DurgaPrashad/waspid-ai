...
> **Waspid is built on the [OpenHands](https://github.com/OpenHands/OpenHands) open-source agent SDK.** This document describes the upstream OpenHands community whose work powers Waspid's agent runtime. Waspid's own community guidelines and channels will be published separately as the platform matures; in the meantime, contributors to the agent runtime should engage with the upstream community below.

## The OpenHands Community (upstream)
